        ...
        <footer class="p-4 rounded-lg shadow md:px-6 md:py-8 bg-gray-800">
            <div class="sm:flex sm:items-center sm:justify-between">
                <a href="#" target="_blank" class="flex items-center mb-4 sm:mb-0">
                    ...
                    <span class="self-center text-xl font-semibold whitespace-nowrap text-white">Larateca</span>
                </a>
            ...
            <span class="block text-sm sm:text-center text-gray-400">© 2025 <a
                    href="https://flowbite.com" target="_blank" class="hover:underline">Larateca™</a>. All Rights Reserved.
            </span>
        </footer>
        <!-- /Footer -->